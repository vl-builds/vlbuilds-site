...
export const translations = {
  ...
  pt: {
    ...
    hero: {
      ...
      body:     'Sites, ferramentas, soluções com IA, planilhas e apresentações — entregues com qualidade profissional, rápido e sem enrolação.',
    ...
    contact: {
      ...
      labelSvc:   'Serviço',
      selectSvc:  'Selecione',
      services:   ['Criação de Site', 'Ferramenta Digital', 'Solução com IA', 'Planilha Excel', 'Apresentação', 'Não sei ainda'],
      labelMsg:   'Mensagem',
  ...
  en: {
    ...
    hero: {
      ...
      body:     'Websites, tools, AI-powered solutions, spreadsheets and presentations — delivered with professional quality, fast and no nonsense.',
    ...
    services: {
      ...
      items: [
        ...
        { n: '05', titulo: 'Presentations',      desc: 'Pitch decks, sales decks and training decks — design that makes an impression.' },
      ],
    },
    process: {
    ...
    contact: {
      ...
      labelSvc:   'Service',
      selectSvc:  'Select',
      services:   ['Website', 'Digital Tool', 'AI Solution', 'Excel Spreadsheet', 'Presentation', 'Not sure yet'],
      labelMsg:   'Message',
  ...
  nl: {
    ...
    hero: {
      ...
      body:     'Websites, tools, AI-oplossingen, spreadsheets en presentaties — geleverd met professionele kwaliteit, snel en zonder gedoe.',
    ...
    services: {
      ...
      items: [
        ...
        { n: '05', titulo: 'Presentaties',      desc: 'Pitch decks, verkoopdecks en trainingsdecks — ontwerp dat indruk maakt.' },
      ],
    },
    process: {
    ...
    contact: {
      ...
      labelSvc:   'Dienst',
      selectSvc:  'Selecteer',
      services:   ['Website', 'Digitale Tool', 'AI-oplossing', 'Excel Spreadsheet', 'Presentatie', 'Weet ik nog niet'],
      labelMsg:   'Bericht',
